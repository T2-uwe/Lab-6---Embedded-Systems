...
void displayclear(){
   for (int line = 0; line < 4; line++) {   // For all 4 lines
        displayCharPositionWrite(0, line);   // Move to start of line
        displayStringWrite("                    "); // Write 20 spaces (for 20 characters wide)
    }
}
